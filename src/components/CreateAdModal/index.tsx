      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed bg-[#2A2634] py-6 px-7 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[488px] shadow-lg shadow-black/25'>
          ...
          <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-2'>
              <CustomInput id='name' name='name' label='Seu nome (ou nickname)' placeholder='Como te chamam dentro do jogo?' />
            </div>

            <div className='grid grid-cols-2 gap-6'>
              <div className='flex flex-col gap-2'>
                <CustomInput id='yearsPlaying' name='yearsPlaying' label='Joga a quantos anos?' placeholder='Tudo bem ser ZERO' type='number' />
              </div>
              <div className='flex flex-col gap-2'>
                <CustomInput id='discord' name='discord' label='Qual seu discord?' placeholder='Usuário#0000' />
              </div>
            </div>
            ...
            <div className='flex gap-6'>
              ...
              <div className='flex flex-col gap-2 flex-1'>
                ...
                <div className='grid grid-cols-2 gap-2'>
                  <CustomInput id='hourStart' name='hourStart' placeholder='De' type='time' />
                  <CustomInput id='hourEnd' name='hourEnd' placeholder='Até' type='time' />
                </div>
              </div>
            </div>
